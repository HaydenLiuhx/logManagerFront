    ...
    methods: {
      handleEdit(index, row) {
        ...
        .then(({ value }) => {
          ...
          axios
            .get(
              `http://47.104.86.90:8082/admin/fixLog?logInfo=${value}&logId=${this.logfile[index].id}`,
              {
                headers: {
...
// },
      ...
      handleDelete(index, row) {
          ...
          axios
            .get(
              `http://47.104.86.90:8082/admin/DeleteLog?logId=${this.logfile[index].id}`,
              {
                headers: {
                  token: sessionStorage.getItem("token")
                }
